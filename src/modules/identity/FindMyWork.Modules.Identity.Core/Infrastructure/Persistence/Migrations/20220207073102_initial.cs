...
namespace FindMyWork.Modules.Users.Core.Infrastructure.Persistence.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SignedById = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcceptedDocument", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AcceptedDocument_Document_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Document",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AcceptedDocument_Users_SignedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcceptedDocument_DocumentId",
                table: "AcceptedDocument",
                column: "DocumentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AcceptedDocument_SignedById",
                table: "AcceptedDocument",
                column: "SignedById");
